...
-->
## [STEP 2] 콘서트 예약 ERD,API명세서, 인프라 구성도 작성
...
-->
- 인프라 구성도, API 명세서를 제대로 작성했는지 잘 모르겠습니다.
...
--> 
- 계산 로직, 단위 테스트 구현 완료
- TODO-예약 가능 날짜 조회, 그리고 날짜의 좌석을 예약하는 api 단위테스트와 함께 구현 (나머지는 후속 작업에서 진행)
- 유저 토큰 발급 api 로직 , 단위 테스트 구현 완료